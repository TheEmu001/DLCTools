...
plt.plot(speed_df['Time Elapsed'], speed_df['CMA'],color='green', marker='o', markersize=0.1, linewidth=0.5, label='CMA')

plt.xlabel('time (seconds)')
plt.ylabel('velocity (Pixels/second)')
plt.legend(loc=2)
plt.title('Normalized Snout Velocity vs. Time for: ' + path)
plt.show()
