...
def velocity(video, fps, no_seconds, DLCscorer, color):
    ...
    b = pd.DataFrame(data={"xsnout": xsnout, "ysnout":ysnout})

    better_dist = np.linalg.norm(a-b.shift())
    all_data[video+" euc dist"] = better_dist
...
if __name__ == '__main__':
    ...
    #          all_data['Paper_Redo_10_17_5mgkg_U50_Ai14_OPRK1_C2_F0_Top Down Dist Travelled'], color='brown')
    # plt.plot(all_data['Paper_Redo_10_17_5mgkg_U50_Ai14_OPRK1_C2_F1_Top Down Time'],
    #          all_data['Paper_Redo_10_17_5mgkg_U50_Ai14_OPRK1_C2_F1_Top Down Dist Travelled'], color='brown')
    ...
    all_data.dropna(axis=1)
    plt.plot(all_data.loc[:108000, ['Paper_Redo_Saline_Ai14_OPRK1_C2_F0_Top Down raw time']], all_data.loc[:108000, ["Average Saline Female Dist"]],
             label='Saline Female Dist', color='#ef24b8')
    # plt.fill_between(all_data.loc[:108000, ['Paper_Redo_Saline_Ai14_OPRK1_C2_F0_Top Down Time']], (all_data.loc[:108000, ["Rolling Average Saline Female"]]-sem_val),
    #                  (all_data.loc[:108000, ["Rolling Average Saline Female"]]+sem_val), alpha=0.5, facecolor='#ef24b8')
