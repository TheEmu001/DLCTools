...
def accelerationCalc(path):
    ...
    acceleration_df['Time Elapsed'] = speed_df['Time Elapsed']
    acceleration_df[fullName] = speed_df['pandas_SMA_3']

    plt.plot(speed_df['Time Elapsed'], speed_df['first der cm'], color='green', marker='o', markersize=0.1,
